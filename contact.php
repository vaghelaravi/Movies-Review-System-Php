						...
						<div class="w3_mail_grids">
								<form action="contact_process.php" method="post">
									<div class="col-md-6 w3_agile_mail_grid">
										...
										<span class="input input--ichiro">
											<input class="input__field input__field--ichiro" type="number" id="input-27" placeholder=" " required="" pattern="[789][0-9]{9}" name="mobile">
									...
									<div class="col-md-6 w3_agile_mail_grid two">
										<textarea  placeholder="Your Message" required="" name="msg"></textarea>
